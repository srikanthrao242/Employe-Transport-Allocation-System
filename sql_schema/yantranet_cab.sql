...
CREATE TABLE `cab` (
  ...
  `cabStatus` varchar(45) DEFAULT NULL,
  `comments` varchar(45) DEFAULT NULL,
  `vacancy` int(11) DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `cab_emp_idx` (`driverId`),
  CONSTRAINT `cab_emp` FOREIGN KEY (`driverId`) REFERENCES `employee` (`id`)
...
INSERT INTO `cab` VALUES (2,1234,2,'AVAILABLE','abcd',4),(3,12345,3,'AVAILABLE','abcd',3);
...
-- Dump completed on 2019-10-27 13:46:39
